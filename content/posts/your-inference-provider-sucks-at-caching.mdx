...
![Bar chart showing how a small drop in prompt cache hit rate multiplies full-price tokens on a 19.5M-token session: 99% hit rate bills 195k tokens at full price, 98% doubles it to 390k, 96% quadruples it to 780k, and 92% is 8× the work at 1.6M tokens.](/blog/your-inference-provider-sucks-at-caching/01-cache-miss-cost-multiplier.jpg)
...
![Figure 1. Replay design diagram: a recorded 155-request, 19.5M-token agent session is re-sent prefix by prefix (step 1, step 1+2, step 1+2+3) as byte-identical requests at recorded pacing to a pinned provider with max_tokens=1. Each response yields three cross-checks: reported cached tokens, billed cost, and time to first token.](/blog/your-inference-provider-sucks-at-caching/02-replay-design.png)
...
![Figure 3. Dumbbell chart comparing each provider's measured prompt cache hit rate on the identical session against OpenRouter's published production hit rate on Aug 16, 2026, with a log-scale bar of full-price work relative to the best cache. DeepSeek leads at 99% measured, followed by Sail Research, Atlas Cloud, Fireworks, StreamLake, and Morph at 98%; the tail is DigitalOcean 75%, Parasail 61%, Wafer 55%, and OpenInference 8%, which does 75× the full-price work of the best cache. The theoretical ceiling is 98.8%.](/blog/your-inference-provider-sucks-at-caching/04-measured-vs-published-hit-rate.jpg)
...
![Table 2. Full results for 18 DeepSeek V4 Flash providers: measured prompt cache hit rate, full-price work relative to the best cache, OpenRouter's published rate on Aug 16, 2026, cost per task at Sep 1, 2026 list prices, and cache TTL. DeepSeek 98.8% hit rate, $0.19, TTL 45+ minutes; Sail Research 98.4%, $0.40; Atlas Cloud 98.1%, $0.70; Fireworks 97.9%, $0.22; StreamLake 97.9%, $0.13; Morph 97.8%, $0.52; DeepInfra 97.2%, $0.35; AkashML 96.6%, $0.35; Phala 96.2%, $0.85; Venice 96.1%, $0.79; GMICloud 94.5%, $0.59; Ambient 88.0%, $0.46; Cloudflare 86.7%, $1.38; SiliconFlow 86.3%, $1.06; DigitalOcean 75.2%, $0.76; Parasail 60.6%, $1.67; Wafer 55.0%, $2.30; OpenInference 7.7%, $0.92. Excluded: Mancer, Novita, Baseten, CoreWeave, and Baidu.](/blog/your-inference-provider-sucks-at-caching/07-full-results-table.jpg)
